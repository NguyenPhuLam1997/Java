...
public class KhachHangForm extends javax.swing.JFrame {
    ...
    public KhachHangForm() {
        initComponents();
        tbKH.setModel(XuLy.KhachHangModel());
    }
    ...
    private void bnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnXoaActionPerformed
        ...
        String MaKH = XuLy.KhachHangModel().getValueAt(n+1, 0).toString();
        int thucThi = XuLy.DeleteKhachHang(MaKH);
        if(thucThi == 0){
    ...
    private void bnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnSuaActionPerformed
        int thucThi = XuLy.UpdateKhachHang(txtMKH.getText(), txtTKH.getText(), txtTCT.getText(), txtDC.getText());
        if(thucThi == 0){
