...
public class NhanVienForm extends javax.swing.JFrame {
    ...
    private void bnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnThemActionPerformed
        ...
        int xuly = XuLy.InsertNhanVien(String.valueOf(txtMNV.getText()),String.valueOf(txtHT.getText()),String.valueOf(txtGT.getText()),String.valueOf(txtDC.getText()));
    ...
    private void bnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnXoaActionPerformed
        ...
        String MaNV = XuLy.NhanVienModel().getValueAt(n, 0).toString();
        XuLy.DeleteNhanVien(MaNV);
        tbNV.setModel(XuLy.NhanVienModel());
